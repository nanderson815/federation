...
const AddKeyPlugin = builder => {
    ...
    builder.hook("GraphQLObjectType", (type, build, context) => {
        ...
        const astNode = Object.assign(Object.assign({}, AST_1.ObjectTypeDefinition({ name: type.name })), type.astNode);
        astNode.directives.push(AST_1.Directive("key", { fields: AST_1.StringValue(primaryKeyNames.join(" ")) }));
        return Object.assign(Object.assign({}, type), { astNode });
    });
    ...
    builder.hook("GraphQLObjectType:interfaces", (interfaces, build, context) => {
         ...
         * output it.
         */
        const astNode = Object.assign(Object.assign({}, AST_1.ObjectTypeDefinition(spec)), Self.astNode);
